...
<small>(Leads to: [Code style](code-style.md), [Data basics](data-basics.md), [Documentation](documentation.md), [Model basics](model-basics.md), [R Markdown basics](rmarkdown-basics.md), [R Markdown](workflow-rmarkdown.md))</small>
