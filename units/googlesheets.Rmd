...
You will be prompted to log into Google. Once you have done this, googlesheets will create a file called `.httr-oauth` in your current directory. __NEVER CHECK THIS INTO GIT OR UPLOAD IT TO GITHUB__. (In the RStudio Git pane, right-click on it and select ignore, then press OK.)
